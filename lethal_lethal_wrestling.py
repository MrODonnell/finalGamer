...
wrestlers = {'Sanaa', 'Bidziil', 'Ishita', 'Brave ', 'Adela', 'The Bionic Man'}
mass = {'Sanaa': 201, 'Bidziil': 190, 'Ishita': 205 , 'Brave': 182 , 'Adela': 180 , 'The Bionic Man': 290 }
sig_moves = {'Sanaa': "Spinning Crane Leg Kick", 'Bidziil': "Lunar Assault" , 'Ishita': "Sleeper Headlock" , 'Brave': "Elevated Elbow Smash", 'Adela': "Firework Neckbreaker", 'The Bionic Man': "Bionic Elbow Drop"}
fin_moves = {'Sanaa': "Praying Mantis", 'Bidziil': "Supernova Body Bomb" , 'Ishita': "Octopus Grip", 'Brave': "Flying Chokeslame", 'Adela': "Two-Handed Gut Buster", 'The Bionic Man': "Shooting Star Spinning Kick"}
...
user_names = ["Sanaa", "Bidziil","Ishita", "Brave", "Adela","The Bionic Man"]
user_response = ''
user_name = ''    
